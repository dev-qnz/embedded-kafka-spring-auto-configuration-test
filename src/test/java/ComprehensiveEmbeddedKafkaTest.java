...
class ComprehensiveEmbeddedKafkaTest {
    ...
    @KafkaListener(topics = TOPIC_NAME, groupId = "comprehensive-listener")
    ...
    void testProducerAndConsumer() throws Exception {
        ...
        try (
            Consumer<String, String> consumer = consumerFactory.createConsumer("comprehensive-consumer", null);
